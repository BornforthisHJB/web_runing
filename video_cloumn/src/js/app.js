...
function signup() {
    ...
    body.on("click", ".login-btn,.must-log-in a,.comment-reply-login", function (t) {
        ...
        }) : $("input[name='user_pass2']").focus() : $("input[name='user_pass']").focus() : this_deft_icon_msg(e, i, iconwarning, riprov2.site_js_text.reg2_txt) : this_deft_icon_msg(e, i, iconwarning, riprov2.site_js_text.reg1_txt)
